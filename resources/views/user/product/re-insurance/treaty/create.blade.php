    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a
                                            href="{{ route('group.index', ['type' => $group->applicable_to]) }}">Groups</a>
                                    </li>
            ...
            <div class="content-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card" style="min-height: 66vh">
                                <h2 class="pl-2 pt-1">Product Mapping Treaty (Re-Insurance)</h2>
                ...
                <div style="display: none;" id="route" data-route="{{ route('treaty.store', $group->id) }}"
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/re-insurance/jexcel-treaty-group.js') }}"></script>
    <script>
