    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"> <a href="{{ route('groups.re-insurance.index', CustomHelper::encode($group->id)) }}">Select Reinsurance Grouping</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card" style="min-height: 66vh">
                                <h2 class="pl-2 pt-1">Product Mapping Facultative (Re-Insurance)</h2>
                                <h4 class="pl-2">Create IFRS 17 Product</h4>
                                {{-- <div class="card-header">
                                    <h4 class="card-title">Create IFRS 17 Product</h4>
                                </div> --}}
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="row w-100  mt-auto">
                                        <div class="col-12 text-right pt-1">
                                            <button id="save"
                                                class="btn btn-{{ ($group->status->slug == 'started' || $group->status->slug == 'expired') && !$group->organization->isBoarding ? 'secondary' : 'primary' }}"
                                                type="button"
                                                {{ ($group->status->slug == 'started' || $group->status->slug == 'expired') && !$group->organization->isBoarding ? 'disabled' : '' }}>
                ...
                <div style="display: none;" id="route" data-route="{{ route('facultative.store', $group->id) }}"
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/re-insurance/jexcel-facultative-group.js') }}"></script>
    <script>
