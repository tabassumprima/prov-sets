        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card" style="min-height: 66vh">
                                <h2 class="pl-2 pt-1">Provision Mapping (Insurance-GMM)</h2>
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <div class="row w-100  mt-auto">
                                        <div class="col-12 text-right pt-1">
                                            ...
                                            {{ !$isBoarding && ($provisionSetting->status->slug == 'started') ? 'disabled' : '' }}>
                ...
                <div style="display: none;" id="route"
                    data-route="{{ route('provision.insurance_gmm.store', $provisionSetting->id) }}"
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/jexcel-provision-gmm.js') }}"></script>
    <script>
