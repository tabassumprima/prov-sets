        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card" style="min-height: 66vh">
                                <h2 class="pl-2 pt-1">Provision Mapping (Insurance)</h2>
                ...
                <div style="display: none;" id="route"
                    data-route="{{ route('provision.insurance.store', $provisionSetting->id) }}"
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/jexcel-provision.js') }}"></script>
    <script>
