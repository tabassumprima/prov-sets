        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Discount rate 1</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ route('user.dashboard') }}">Dashboard</a>
                                </li>
                                <li class="breadcrumb-item"><a href="#">Discount rate</a>
                                </li>
                                <li class="breadcrumb-item active">Discount rate 1
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><span class="font-weight-bold">Discount rate 1</span></td>
                                                <td>
                    ...
                    <div class="modal-dialog">
                        <form class="add-new-user modal-content pt-0" action="#">
                            ...
                            <div class="modal-header mb-1">
                                <h5 class="modal-title" id="exampleModalLabel">Upload new Discount Rate</h5>
                            </div>
