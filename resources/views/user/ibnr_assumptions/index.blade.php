                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row w-100">
                                    ...
                                    @authorize('create-ibnr-assumption', true)
                                    ...
                                    <table class="table data-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @can('view-ibnr-assumption-file', true)
                                                    <a href="{{ route('ibnr-assumptions.files.index', ['ibnr_assumption' => CustomHelper::encode($record->id)]) }}">{{ $record->name }}</a>
                                                    @else
                                                    {{ $record->name }}
                                                    @endcan
                                                </td>
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            @if($isboarding)
                                                            <a class="dropdown-item" href="{{ route('ibnr-assumptions.edit', ['ibnr_assumption' => CustomHelper::encode($record->id)]) }}">
                                                                <i data-feather="edit-2" class="mr-50"></i>
                                                                <span>Edit</span>
                                                            </a>
                                                            <a class="dropdown-item delete" data-route="{{ route('ibnr-assumptions.destroy', ['ibnr_assumption' => CustomHelper::encode($record->id)]) }}">
                                                                <i data-feather="trash" class="mr-50"></i>
                                                                <span>Delete</span>
                                                            </a>
                                                            @endif
                                                            @authorize('update-status-ibnr-assumption', true)
                ...
                <div class="modal modal-slide-in new-user-modal fade" id="modals-slide-in">
                    <div class="modal-dialog">
                        <form class="add-new-user modal-content pt-0" method="post"
                            action="{{ route('ibnr-assumptions.store') }}">
                            @csrf
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">×</button>
                            <div class="modal-header mb-1">
                                <h5 class="modal-title">New IBNR Factors</h5>
                            </div>
                            <div class="modal-body flex-grow-1">
                                <div class="form-group">
                                    <label class="form-label" for="name">Name</label>
                                    <input type="text" class="form-control" id="name" placeholder="IBNR - Motor"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="myModalLabel120">Delete IBNR Assumption</h5>
                            ...
                            <form id="delete-ibnr-form" method="post">
                                @csrf
                                @method('delete')
...
<script>
    $(document).on('click', '.update-file', function() {
        ...
        var value = $(this).data('status');
            var url = '{{ route('ibnr.file.status', ['ibnr_assumptions' => ':id']) }}';
    ...
    $(".delete").on('click', function() {
        ...
        document.getElementById('delete-ibnr-form').action = route;
    });
</script>
@endSection