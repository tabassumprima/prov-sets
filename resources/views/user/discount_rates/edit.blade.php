                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"> <a href="{{ route('discount-rates.index') }}">Discount Rate</a>
                                    </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <form class="form-validate" method="POST"
                                         action="{{ route('discount-rates.update', ['discount_rate' => CustomHelper::encode($record->id)])}}"
                                        ...
                                        <input type="text" id="description" class="form-control"
                                            placeholder="This is the new Discount Rate" aria-label="description"
