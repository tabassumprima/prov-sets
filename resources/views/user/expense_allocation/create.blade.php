...
@section('content')
    ...
    <div class="app-content content">
        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            <div class="breadcrumb-wrapper w-100">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="">Expense Allocation</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card" style="min-height: 66vh">
                                <h2 class="pl-2 pt-1">Expense Allocation</h2>
            ...
            <div style="display: none;" id="gl_code_desc" data-gl_code_desc='@json($codeDescList)'></div>
            <div style="display: none;" id="expense_types" data-expense_types='@json($expense_types)'></div>
            <div style="display: none;" id="allocation_rate" data-allocation_rate='@json($allocation_rate)'></div>
            <div style="display: none;" id="allocation_basis" data-allocation_basis='@json($allocation_basis)'></div>
            <div style="display: none;" id="route"
                    data-route="{{ route('provision-setting.expense-allocation.store', ['provision_setting' => $provisionSetting->id]) }}"
...
@section('scripts')
    ...
    <script src="{{ asset('assets/js/jexcel-expense-alloc.js') }}"></script>
    <script>
