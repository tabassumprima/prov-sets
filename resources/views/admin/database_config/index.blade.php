                            ...
                            <div class="col-lg-12 col-xl-6 pl-xl-75 pl-0">
                                <div
                                    ...
                                    <div class="dt-buttons btn-group flex-wrap">
                                        <form action={{ route('db_config.create') }}>
                            ...
                            <table class="user-list-table table data-table">
                                ...
                                @foreach ($configs as $config)
                                    <tr>
                                        ...
                                        <td>{{ $config->name }}</td>
                                        <td>
                                            <a id="config_edit:{{ $config->id }}"
                                                href="{{ route('db_config.edit', [CustomHelper::encode($config->id)]) }}">
                                                <i data-feather="edit"></i></a>

                                            <a class="delete"
                                                data-route="{{ route('db_config.destroy', [CustomHelper::encode($config->id)]) }}"><i
