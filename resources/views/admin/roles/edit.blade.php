                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="account" aria-labelledby="account-tab" role="tabpanel">
                                    ...
                                    <form class="form-validate" method="POST"
                                        action="{{ route('roles.update', [CustomHelper::encode($role->id)]) }}"
                                        autocomplete="off">
                                        @csrf
                                        @method("PUT")
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <input type="hidden" value="{{ CustomHelper::encode($role->id) }}"
                                                        name="role_id" />
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            <label for="username" class="">Role Name</label>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="custom-control custom-control-success custom-checkbox">
                                                                                        <input type="checkbox" name="permissions[]"
                                                                                            ...
                                                                                            value="{{ $permission }}" {{$role->hasPermissionTo($permission)? "checked": ""}} />
