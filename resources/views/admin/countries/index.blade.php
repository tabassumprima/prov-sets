                            ...
                            <div class="col-lg-12 col-xl-6 pl-xl-75 pl-0">
                                <div
                                    ...
                                    <div class="dt-buttons btn-group flex-wrap">
                                        <form action={{ route('countries.create') }}>
                            ...
                            <table class="user-list-table table data-table">
                                ...
                                @foreach ($countries as $country)
                                    <tr>
                                        <td>{{ $country->name }}</td>
                                        <td>{{ $country->code }}</td>
                                        <td>{{ $country->zone . ' ' . $country->offset }}</td>
                                        <td>
                                            <a id="country_edit:{{ $country->id }}"
                                                href="{{ route('countries.edit', [CustomHelper::encode($country->id)]) }}">
                                                <i data-feather="edit"></i></a>
                                            <a class="delete"
                                                data-route="{{ route('countries.destroy', [CustomHelper::encode($country->id)]) }}"><i
