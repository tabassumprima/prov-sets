...
class ClaimPattern extends Model
{
    use HasFactory, Loggable;
    protected $fillable = ['organization_id', 'name', 'description', 'status_id'];
    ...
    {
        return $this->hasMany(ProvisionMapping::class, 'claim_pattern_id');
    }
